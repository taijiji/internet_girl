...
## 提案背景
- インターネットおよびネットワークは、技術とビジネス、企業同士の思惑が絡み合うとても面白い世界です。しかしその実態は、ネットワーク業界に就職した人間にしか知られていない、非常に見えづらい世界でもあります。プログラマやITエンジニアであっても、実はインターネットの実態を知らない人が多く、身近にはあるものの詳細はよくしらない、という「ブラックボックス」と化している存在となっています。
- ネットワーク業界で最大の悩みは、人材不足です。学生が、就職前にネットワーク業界のことを知る余地が無いため、どのネットワーク関連企業も、良い学生の獲得に四苦八苦しています。知名度のある「プログラマ」「ITエンジニア」と比べると、「ネットワークエンジニア」という職業の存在さえ知られてない実情があります。
- 本企画を通して、小中高生の方に「インターネットの裏側の世界」に興味をもってもらい、「ネットワークエンジニアの職業の存在意義」を認知してもらうことで、将来の人生設計や職業選択の検討材料にしていただきたいです。

## 企画者: 土屋 太二について
- 36歳で、業界歴11年の現役のネットワークエンジニア。現在はアメリカ系企業にリモート勤務。
...
- 副業として以下のプロジェクトに取り組む。
  - [YouTube チャンネル show int](https://www.youtube.com/@showint)
    ...
    - 現在３社のスポンサー企業(いずれもネットワーク関連企業)からの資金提供を受けて運営。
...
### 企画者の想い
これまでの個人活動のなかで、インターネットの裏側の世界や、ネットワークエンジニアの仕事の面白さを、いろんな人に伝えたい！という想いで、さまざまな対外活動をしてきました。
そのなかでも、以下のYouTube動画が、非常に多くの人にご視聴いただいて、特に学生さんや営業職の方など、ネットワーク業界ではない方からのフィードバックを多くいただきました。
...
この動画で紹介した内容を、さらに中高生にも広めることができれば、将来の職業の選択肢として、ネットワークエンジニア・インフラエンジニアの仕事に興味を持っていただける学生さんの数が増やせられるのではないかと期待しています。
中高生にも興味もっていただくためのメディアとして、小説もしくは児童書というテーマに落とし込めないかチャレンジしたい、というのが今回の企画の最大のモチベーションです。

可能であれば、これまでの個人活動では実現できなかった「世界中の人たちにも価値を届ける」という想いがあることから、もし本企画の日本語書籍化が成功したら、将来的に英語翻訳して世界展開までできたら最高です。 
...
- ハル (中学１年生、女の子)
  ...
  - めんどくさがりで、不平不満が多い。でも一度興味がでたら、どっぷりのめり込むタイプ。
...
動画をいくつか見ていたら、いつのまにかウトウトと眠ってしまいました。
...
ロボタ「まぁまぁそう言わずに。どうせ一人じゃ道も分からなくて帰れないでしょ？せっかくだからちょっとつきあってよ。」
...
1. インターネットを支えるインフラエンジニア/ネットワークエンジニアのお仕事をのぞいてみよう
1. (余裕があれば) インフラエンジニア/ネットワークエンジニアになるには、どういう進路を進めばいい？
...
- [ルビィのぼうけん インターネットたんけん隊(翔泳社)](https://www.amazon.co.jp/dp/4798159867)
  - 対象年齢は5歳以上。
  - 幼児向けに特化されており、技術解説よりも絵本としての要素が強い。ただし絵本の内容はかなり抽象的なので、これだけで技術の概念が学べるかというと、やや疑問。
